 ...
 */
class GetDirectoryEntries @Inject
internal constructor(val repository: Repository, threadExecutor: ThreadExecutor,
                     postExecutionThread: PostExecutionThread) : UseCase<List<ItemTemplate>, GetDirectoryEntries.Params>(
        threadExecutor, postExecutionThread) {

    override fun buildUseCaseObservable(params: Params): Observable<List<ItemTemplate>> {
        return repository.getDirectoryEntries(params.authToken, params.repoID, params.directory)
    }
